    ...
    def run(self) -> Dict:
        ...
        self.logs.update({
            ...
            "notes": [
                ...
                "Stage 3 greedily applies LoRA rank masks B @ diag(mask) @ A with verification and rollback.",
            ],
        ...
        save_json(os.path.join(self.output_dir, "residual_localization.json"), localization)
        self._write_jsonl(
        ...
        save_json(os.path.join(self.output_dir, "retain_calibration.json"), calibration)
        self._write_jsonl(
        ...
        save_json(os.path.join(self.output_dir, "forget_residual_before_after.json"), {
