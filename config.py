...
# LLM Model
################
parser.add_argument('--llm_base_model', type=str, default='/data/users/hjy/models/Llama-2-7b-hf')
parser.add_argument('--llm_base_tokenizer', type=str, default='/data/users/hjy/models/Llama-2-7b-hf')
...
# Unlearning
################
parser.add_argument('--forget_ratio', type=float, default=0.0)
