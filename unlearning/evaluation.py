...
def evaluate_unlearning(
    ...
    args,
    output_dir: str,
    preserve_predictions_before: bool = False,
) -> Dict:
    ...
    predictions_before_path = os.path.join(output_dir, "predictions_before.json")
    if not preserve_predictions_before or not os.path.exists(predictions_before_path):
        _save_json(predictions_before_path, predictions_before)
